...
public class Usuario {
    ...
    public void setUrlImagem(@Size(max = 1000, message = "A url da imagem deve ter no máximo 1000 caracteres.") String urlImagem) {
        this.urlImagem = urlImagem;
    }
    ...
    public void setEmail(@NotBlank(message = "O atributo Email é obrigatório!") @Email(message = "O atributo Email deve ser válido!") String email) {
        this.email = email;
    }
    ...
    public void setObjetivoPrincipal(@Size(max = 255, message = "O objetivo principal deve ter no máximo 255 caracteres.") String objetivoPrincipal) {
        this.objetivoPrincipal = objetivoPrincipal;
    }
